...
class HomesAdapter : RecyclerView.Adapter<HomesAdapter.HomesViewHolder>() {
    ...
    inner class HomesViewHolder(
        ...
        fun bind(item: DomainHome) {
            ...
            binding.homeEnergy.text = item.usagePower.toString()
            binding.homeEnergy.text = context?.getString(R.string.home_energy_use).plus(item.usagePower.toString().plus(context?.getString(
